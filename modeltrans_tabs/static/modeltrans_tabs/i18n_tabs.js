(() => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        i18nFields.forEach((field) => {
            ...
            let groupName_ = field.dataset.i18nField;
            ...
            if (formsetsContainer) {
                ...
                groupName_ = `${formset.options.prefix}-${formsetIndex}-${field.dataset.i18nField}`;
            }

            if (!fieldGroups[groupName_]) {
                let selector = `[name=${groupName_}]`;
                ...
                fieldGroups[groupName_] = {
                    defaultField: defaultField,
                    fields: [],
                    isTemplate: formsetIndex === "__prefix__",
                };
            }
            fieldGroups[groupName_].fields.push(field);
        });
